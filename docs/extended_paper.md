...
![Three-dimensional trajectories of sixty scenarios from differential equation and discrete time difference equation models.](images/sixty_models.png)

*__Figure 1.__ Three-dimensional trajectories of sixty scenarios simulated with the Interfere
...
initial conditions or historic observations. For example, the following code block produces the trajectories similar to those plotted in Figure 2:
...
![Simulation of the quadratic Belozyorov system.](images/original_trajectory.png)

*__Figure 2. Simulation of System:__ The natural, uninterupted evolution of the quaratic Belozyorov system [@belozyorov_exponential_2015] with the addition of a small
amount of stochastic noise simulated using the Interfere package (only two of three dimensions shown).*
...
Next, we can take exogenous control of $x$ by pinning it to $\sin(t)$ and simulate the response of
 ...
 altered by this particular intervention. See Figure 3 to see how the quadratic Belozyorov system [@belozyorov_exponential_2015] responds to this intervention.
...
*__Figure 3. System trajectory with intervention:__ The figure above demonstrates the
...
the natural evolution behavior of the system.*
...
input signal applied during forecasting. Figure 4 demonstrates the optimized model's ability to forecast the intervention response.
...
![Forecasting intervention response of the Belozyorov system.](images/prediction_comparison.png)

*__Figure 4. Forecasting Intervention Response:__ Example of forecasting the response of
...
curve). However, not all intervention responses can be so accurately predicted. See the bottom left of Figure 5 for a failed forecast scenario.*
...
![Comparing intervention response prediction for deterministic and stochastic systems.](images/det_v_stoch.png)

*__Figure 5.__ Example experimental setup possible with Interfere: Can stochasticity help reveal associations between variables? Interfere can be used to comparing intervention response prediction for deterministic and stochastic versions of the same system.*
